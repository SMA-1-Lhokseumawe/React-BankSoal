      ...
      <div className="max-w-full mx-auto">
        <div className="bg-white dark:bg-secondary-dark-bg rounded-xl shadow-lg overflow-hidden mx-8">
          ...
          <div className="py-4 px-6" style={{ backgroundColor: currentColor }}>
            <h1 className="text-xl font-bold text-white">Edit Modul Belajar</h1>
          </div>
          ...
          <div className="p-10">
            <form onSubmit={updateModul} className="space-y-8">
              ...
              <div className="flex items-center justify-between pt-8 px-6">
                ...
                >
                  {isSubmitting ? "Menyimpan..." : "Update Modul"}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-gray-700 dark:text-white">
                Edit modul belajar akan langsung tercatat dalam sistem. Pastikan
