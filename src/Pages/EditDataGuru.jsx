...
const EditDataGuru = () => {
  ...
  const formatDateForInput = (isoDateString) => {
    ...
    return date.toISOString().split('T')[0]; // Mendapatkan format YYYY-MM-DD
  };
  ...
  const getGuruById = async () => {
    ...
    setTanggalLahir(formatDateForInput(response.data.tanggalLahir));
      ...
      <div className="max-w-full mx-auto">
        <div className="bg-white dark:bg-secondary-dark-bg rounded-xl shadow-lg overflow-hidden mx-8">
          ...
          <div className="py-4 px-6" style={{ backgroundColor: currentColor }}>
            <h1 className="text-xl font-bold text-white">Edit Profile Guru</h1>
          </div>

          {/* Form */}
          <div className="p-10">
            <form onSubmit={updateGuru} className="space-y-8">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-gray-700 dark:text-white">
                Perubahan profile guru akan langsung tercatat dalam sistem.
