...
const StartQuizLagi = () => {
  ...
  const formatQuestions = () => {
    if (!quizData || !quizData.soals || !quizData.soals.length) {
      return [];
    }

    // Format the questions from the API data
    return quizData.soals.map((item) => {
      ...
      return {
        ...
        category: quizData.pelajaran ? quizData.pelajaran.pelajaran : "Umum",
        correctAnswer: item.correctAnswer,
      };
    });
  };

  const questions = quizData ? formatQuestions() : [];
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      const quizResultData = {
        ...
        pelajaranId: quizData.pelajaranId,
        kelasId: quizData.kelasId,
        siswaId: siswaId,
      ...
      navigate(`/hasil-quiz/${response.data.nilaiId || id}`);
    } catch (error) {
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Skor baru Anda akan menggantikan skor sebelumnya.
                  </p>
                </div>
              </div>
              ...
              <ul className="list-disc pl-5 text-gray-600 dark:text-gray-300 space-y-1">
                <li>
                  ...
                  <span className="font-medium">
                    {quizData.pelajaran ? quizData.pelajaran.pelajaran : "Tidak Tersedia"}
                  </span>
                </li>
                <li>
                  Kelas:{" "}
    ...
    <div className="p-6 dark:bg-gray-900 min-h-screen">
      ...
      <div className="max-w-5xl mx-auto mb-6 bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md flex justify-between items-center">
        <div className="flex items-center">
          <span className="font-medium text-gray-700 dark:text-gray-300">
            {quizData.pelajaran ? quizData.pelajaran.pelajaran : "Quiz"}
          </span>
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden mb-6">
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
            <div className="flex items-center justify-between">
              <h3 className="font-medium text-gray-700 dark:text-gray-300">
                Soal kategori: {questions[currentQuestion]?.category || "Umum"}
              </h3>
          ...
          {/* Question */}
          <div className="p-6">
            {questions.length > 0 && renderQuestionContent(questions[currentQuestion])}
