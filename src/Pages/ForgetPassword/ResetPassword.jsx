...
const ResetPasswordViaEmail = () => {
  ...
  const handleSuccessModalClose = () => {
    setShowModal(false);
    navigate("/login"); // Redirect ke halaman login setelah reset password berhasil
  };
  ...
  const handleErrorModalClose = () => {
    ...
    if (modalType === "invalid") {
      navigate("/forgot-password"); // Redirect ke halaman forgot password jika token expired
    }
  };
