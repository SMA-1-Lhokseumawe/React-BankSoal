      ...
      <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
          <div class="border border-gray-300 rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
            <form class="space-y-4">
              <div class="mb-8">
                ...
                <p class="text-gray-500 text-sm mt-4 leading-relaxed">Masuk ke akun Anda dan temukan berbagai fitur untuk meningkatkan pembelajaran Anda. Perjalanan Anda menuju prestasi dimulai di sini.</p>
              </div>
              ...
              <div class="!mt-8">
                <button type="button" class="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-orange-600 hover:bg-orange-700 focus:outline-none">
                  Log in
                </button>
              </div>
            </form>
          ...
          <div class="lg:h-[400px] md:h-[300px] max-md:mt-8">
            <img src={Image} class="w-full h-full max-md:w-4/5 mx-auto block object-cover" alt="Gambar Image Login" />
          </div>
        </div>
      </div>
    </div>
